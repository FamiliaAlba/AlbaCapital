...
const Blog = () => {
  ...
  const categories = ["TODOS", "SOSTENIBILIDAD", "DISEÑO", "URBANISMO"];
          ...
          <div className="max-w-7xl mx-auto">
            <div className="mb-12">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl">
                Exploramos la intersección entre arquitectura, diseño y experiencia humana 
                a través de análisis reflexivos y perspectivas contemporáneas.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-12">
              Suscribite a nuestro newsletter para recibir las últimas ideas sobre arquitectura y diseño
            </p>
